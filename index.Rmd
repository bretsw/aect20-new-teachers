...
*I seek to understand how new teachers navigate the edu-verse to look for help with challenges experienced during induction.*
...
- and **supports** (knowledge, skills, curricular materials, and encouragement)
...
--
  ...
  - How does a new teacher intentionally assemble the pieces of their PLN to make a holistic system that meets their induction needs?
...
- MSU College of Education Master's students
...
- Connecting socially, including *social glue*  (positive) and *social comparison* (negative)
...
```{r, out.width = "180", echo = FALSE, fig.align = "center"}
include_graphics("img/edu-verse.jpg")
```
...
- These are not yet fully understood by educational researchers or education leaders
...
- As the edu-verse continues to expand, new teachers’ and education leaders’ understanding of emerging learning ecologies and agency must expand as well.
